// Supabase Edge Function: genera embedding via modello gte-small built-in
// Deploy: supabase functions deploy embed
// Chiamata: POST /functions/v1/embed  { "input": "testo da vettorizzare" }
...
serve(async (req) => {
  ...
  try {
    ...
    // Supabase AI built-in — gte-small, 384 dimensioni, gratuito
