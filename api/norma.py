...
ARTICOLI_TESTO = {
    ...
    "l_241_1990": {
        ...
        "art. 7 — comunicazione avvio del procedimento": (
            "L’amministrazione comunicaica l’avvio del procedimento ai soggetti nei confronti dei quali il "
...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        # Costruisci articoli_dettaglio nel formato atteso da renderDetail()
